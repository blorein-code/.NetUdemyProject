...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        {
            await _unitOfWork.Categories.AddSync(new Category
            {
                ...
                IsDeleted = false
            }).ContinueWith(t=>_unitOfWork.SaveAsync());//Task
        ...
        var category = await _unitOfWork.Categories.GetAsync(c => c.Id == categoryId, c => c.Articles);
            ...
            return new DataResult<Category>(ResultStatus.Error, "Bölye bir kategori bulunamadı", null);
        }
